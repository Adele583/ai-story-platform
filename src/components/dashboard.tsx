...
export function Dashboard() {
  ...
  const handleNewStory = () => {
    toast({
      ...
      description: "Your new story has been created. Happy writing!",
    })
  }
      ...
      <div className="flex h-screen overflow-hidden">
        ...
        <aside className="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 p-4 flex flex-col">
          ...
          <div className="mt-auto space-y-2">
            <Button onClick={handleUpgrade} className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:from-purple-600 hover:to-pink-600 transition-all duration-200">
